...
You can follow the steps below to setup your personal computer with a programming environment similar to the one we use in class. Follow the installation steps in order from top to bottom.


1. Anaconda
---------------
 Download the `Anaconda installer <https://www.anaconda.com/products/individual#Downloads>`_ for your operating system. Open the installer file and follow the installation steps.
...
3. Pycat
---------
Install the latest version or pycat. Open the Anacona Terminal application and run the command
...
git-scm
^^^^^^^^
Install `git <https://git-scm.com/downloads>`_ if you would maintain a repository for code your write and track changes.
