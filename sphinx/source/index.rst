...
2. Shooting Bullets with ``on_left_click_anywhere()``
   ...
   Then implement your Bullet class. (Remember ``pycatSprite`` auto-complete?)
   ...
   - Add a new property for the bullet speed i.e. ``self.speed``
   - We want each bullet to shoot towards the mouse cursor. To set the correct rotation you can use ``self.point_toward_mouse_cursor()``.
