...
* `Lessons <lessons.rst>`_ has some resources for our in-class lessons.
* `Homework <homework.rst>`_ posts the assigned homework.
* `Notes <notes.rst>`_ include more details about Python and the topics we cover in class.
* `Tutorials <tutorials.rst>`_ includes tutorials for the programming tools we use.
